...
public class UserCreate<baseUrl> {
    ...
    public String getUsers(Map<String,String> testData) throws IOException  {
        ...
        auditPojo.setLocalTime(testData.get("localTime")+generateRand.dateTime());
        auditPojo.setGMTTime(testData.get("GMTTime")+generateRand.dateTime());
        auditPojo.setAppRequestedTime(testData.get("appRequestedTime")+generateRand.dateTime());
